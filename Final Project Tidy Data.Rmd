...
# pisa_vs_gdp <- pisa_vs_gdp %>%
  #pivot_longer(c("reading", "math", "science"), names_to = "test_type", values_to = "score")
```
...
pisa_vs_homicide <- pisa_vs_homicide %>%
  pivot_longer(c("reading", "math", "science"), names_to = "test_type", values_to = "score")
```
...
pisa_vs_lifeexp <- pisa_vs_lifeexp %>%
  pivot_longer(c("reading", "math", "science"), names_to = "test_type", values_to = "score")
```
